...
export function validateCompilerOptions(opts: ts.CompilerOptions, projectPath: string) {
	...
	// eslint-disable-next-line deprecation/deprecation -- code specifically warns about using the deprecated item
	if (opts.importsNotUsedAsValues !== undefined) {
		// eslint-disable-next-line deprecation/deprecation -- see above

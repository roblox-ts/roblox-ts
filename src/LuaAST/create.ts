...
export function func(args: lua.Identifier[] = [], hasVarArgs = false, statements: lua.Statement[] = []) {
...
export function whileDo(condition: lua.Expression, statements: lua.Statement[] = []) {

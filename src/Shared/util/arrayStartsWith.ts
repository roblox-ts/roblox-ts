/**
 * Returns if the shorter of `a` and `b` contains items that are equivalent to their parallel item in the longer array. 
 * Essentially, if the longer array starts with the shorter array.

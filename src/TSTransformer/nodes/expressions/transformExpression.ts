...
import { transformTypeAssertionExpression } from "TSTransformer/nodes/expressions/transformTypeAssertionExpression";
import {
...
const TRANSFORMER_BY_KIND: Partial<Record<ts.Expression["kind"], ExpressionTransformer>> = {
	// banned expressions

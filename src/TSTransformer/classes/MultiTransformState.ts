import type { FunctionSymbolInfo } from "TSTransformer/util/summarizeFunctionSymbol";
...
export class MultiTransformState {
	...
	public readonly functionAnalysisPendingSymbols = new Set<ts.Symbol>();
	public functionAnalysisSawPendingSymbol = false;
	public readonly effectFreshTempIds = new Set<number>();
	public effectMaskedOperandTags: ReadonlySet<number> | undefined;
